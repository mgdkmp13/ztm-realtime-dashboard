  ...
  <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-100 via-pink-50 to-purple-100 px-4">
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600 mt-3 text-lg">Zaloguj się do swojego konta</p>
      </div>
      ...
      <div class="card">
        <form @submit.prevent="handleLogin">
          <div class="space-y-4">
            ...
            >
              <span v-if="!authStore.isLoading">Zaloguj się</span>
        ...
        <div class="mt-6 text-center">
          <p class="text-sm text-gray-600">
            Nie masz konta?
            <router-link to="/register" class="text-pink-500 hover:text-pink-600 hover:underline font-bold">
              Zarejestruj się
            </router-link>
          </p>
        </div>
...
const handleLogin = async () => {
  ...
  if (result.success) {
    ...
    notify.error(result.error || 'Logowanie nie powiodło się')
  }
}
</script>
